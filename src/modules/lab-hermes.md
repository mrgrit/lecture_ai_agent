...
**둘째, 기대 결과를 눈으로 확인하고 넘어간다.** 이 실습편의 목적은 진도가 아니라 "정말 도는구나"를 열아홉 번 반복해서 체감하는 것이다. 화면이 기대 결과와 다르면 거기서 멈추고 원인을 찾는다. 그게 실습이다.
...
실습 열아홉 개가 끝났다. 여기서 만든 것은 전부 장난감이지만, **구조는 실무와 같다.**
