...
reg("lab-map", W, _map()[1],
    "실습편은 준비 3개, 스킬과 커넥터 4개, 하니스 5개, 루프 4개, 기억과 그래프 3개, 명세 주도 개발 4개로 구성되며 각각 강의 모듈 1에서 4에 대응한다. 스물세 개를 마치면 스킬·커넥터·승인과 훅·게이트·감시 루프·메모장·기억 그래프·근거 검증기 여덟 조각이 남고, 이를 조립하면 밤새 도는 에이전트가 된다.",
    _map()[0])
